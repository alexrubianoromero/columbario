function pantallaInicialClientesNew(){
    ...
    http.send("opcion=pantallaInicialClientesNew"
    );
}
function formuModificarCLiente(idCliente){
    const http=new XMLHttpRequest();
    const url = '../clientes/clientes.php';
    http.onreadystatechange = function(){
        if(this.readyState == 4 && this.status ==200){
    ...
    http.open("POST",url);
    http.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    http.send("opcion=formuModificarCLiente"
          + "&idCliente="+idCliente
    );
}
function actualizarCliente(idCliente){
    ...
    http.open("POST",url);
    http.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    http.send("opcion=actualizarCiente"
          + "&idCliente="+idCliente
          + "&identidad="+identidad
          + "&nombre="+nombre
          + "&telefono="+telefono
...
function verClientesNuevo(){
    ...
    http.open("POST",url);
    http.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    http.send("opcion=verClientesNuevo"
    );
}


function eliminarClienteLogico(idCliente){
    const http=new XMLHttpRequest();
    const url = '../clientes/clientes.php';
    http.onreadystatechange = function(){
        if(this.readyState == 4 && this.status ==200){
    ...
    http.open("POST",url);
    http.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    http.send("opcion=eliminarClienteLogico"
          + "&idCliente="+idCliente
    );
    mostrarClientes();
}
